...
public abstract class StringUtils {
    ...
    public static String subUtil(String originStr, String regex) {
    ...
    public static void main(String[] args) {
		List<String> list = Arrays.asList("3","3","3","3","3","3","3","3","3","3","4");
		int listSize = list.size();
		int preNum = listSize / 4;
		System.out.println(listSize+ "::" + preNum);
		System.out.println(Lists.partition(list, preNum));
	}
